...
export default function CreatePermissionModal({ open, onOpenChange, onPermissionCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-md rounded-lg border border-border bg-card p-6 shadow-lg">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Add a new permission to your system</p>

        <div className="mt-6">
          <label className="block text-sm font-medium text-foreground mb-2">Permission Name</label>
          <input
            type="text"
