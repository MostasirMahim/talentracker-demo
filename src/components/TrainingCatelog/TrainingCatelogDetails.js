      ...
      <div className="row">
        ...
        <main className="col-lg-8">
          ...
          {training.thumbnail_image && (
            <div className="apex-thumbnail-wrapper mb-4 rounded overflow-hidden shadow">
              <img
        ...
        <aside className="col-lg-4">
          ...
          <div className="card apex-trainer-card mb-4 shadow">
            <div className="card-header apex-card-header bg-dark text-white">
              <h5 className="mb-0">Expert Trainer</h5>
            </div>
            <div className="card-body text-center">
              {trainer.profile_picture && (
                <div className="apex-trainer-img-wrapper mb-3 mx-auto">
                  <img
                    ...
                    alt={trainer.name}
                    className="apex-trainer-img rounded-circle border border-5 border-light shadow-sm"
                  />
                </div>
              )}
              ...
              <p className="apex-trainer-bio small text-start">
                {trainer.biography}
              </p>
              <hr />
