          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="call-back-request-img">
                <Image
                  src="/images/call-back-request2.png"
                  alt="image"
                  width={705}
                  height={607}
                />
            ...
            <div className="col-lg-6 col-md-12">
              <div className="call-back-request-text">
                ...
                <p>
                  ...
                  diam nonumy a eirmod tempor invidunt ut labore et dolore magna
                  aliquyam erat, sed diam voluptua. At verorh eos et accusam at
                  vero eos et accusam.
                </p>
