    ...
    <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-6 space-y-8">
          ...
          {compensation.length > 0 && (
            <div className="border rounded-lg p-4 bg-gray-50">
              <p>
                ...
                {compensation[0].current_salary} {compensation[0].currency}
              </p>
              <p>
                <strong>Other benefits:</strong>{" "}
                {compensation[0].other_benefits}
              </p>
              <p>
          ...
          {documents.length > 0 && (
            <div className="border rounded-lg p-4 bg-gray-50 space-y-2">
              ...
              <p>
                ...
                <p>{documents[0].portfolio_links}</p>
              </p>
              <p>
      ...
      <div className="flex justify-end gap-4 pt-4 border-t">
        ...
        <button
          ...
          className="flex items-center cursor-pointer gap-2 bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition"
        >
          PDF
        </button>
      </div>
