...
export default function AdminSmartPagination({ paginationData, className = "" }) {
    ...
    <div className={`py-12 ${className}`}>
      <nav aria-label="Blog pagination">
        <ul className="flex flex-wrap justify-center items-center gap-2 mb-4">
          ...
          <li>
            <button
              className="inline-flex items-center cursor-pointer gap-2 px-6 py-2 border-2 border-blue-600 rounded-xl font-semibold text-blue-600 transition-transform duration-300 hover:bg-blue-600 hover:text-white disabled:opacity-40 disabled:cursor-not-allowed"
          ...
          {generatePageLinks().map((page, i) =>
            page === "..." ? (
              ...
              <li key={page}>
                <button
                  className={`w-11 h-11 flex items-center cursor-pointer justify-center rounded-lg border-2 border-gray-200 font-semibold text-gray-700 transition-transform duration-300 hover:border-blue-600 hover:text-white-600 ${page === current_page ? "bg-gradient-to-tr from-blue-500 to-blue-700 text-white shadow-lg scale-105" : ""}`}
          ...
          <li>
            <button
              className="inline-flex cursor-pointer items-center gap-2 px-6 py-2 border-2 border-blue-600 rounded-xl font-semibold text-blue-600 transition-transform duration-300 hover:bg-blue-600 hover:text-white disabled:opacity-40 disabled:cursor-not-allowed"
