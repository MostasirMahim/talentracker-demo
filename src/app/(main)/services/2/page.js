          ...
          <div className="col-lg-8 col-md-12">
            ...
            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 service-card">
              ...
              <p className="text-secondary mb-4" style={{ lineHeight: "1.8" }}>
                In today’s fast-changing business environment, talent
                acquisition needs to be fast, consistent, and scalable. Our RPO
                solution acts as an <b>extension of your HR team</b>, managing
                recruitment end-to-end with precision and accountability.
              </p>
              ...
              <div className="mb-4">
                <p className="text-secondary mb-3">
                  ...
                  screening, and employer branding techniques to ensure every
                  hire is the <b>right hire</b>.
                </p>
