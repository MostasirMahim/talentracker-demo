...
export default function Page() {
  const service = projects.find((item) => item.id === 9);
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            ...
            {service?.image && (
              <Image
                src={service.image}
                alt={service.altText || "Employer of Record & PEO Services"}
                width={1260}
                height={380}
                className="rounded-4"
              />
            ...
            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 service-card">
              ...
              <p className="text-secondary mb-4" style={{ lineHeight: "1.8" }}>
                Operate in Bangladesh without opening a local entity. We become
                the legal employer of your team, handling compliance, HR admin,
                payroll, and benefits — while you manage work activities.
              </p>
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  >
                    “Expand globally. We handle the legal, HR, and compliance
                    side.”
                  </p>
                </blockquote>
              </div>
